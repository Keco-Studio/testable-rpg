...
| P1 | Full guard path is completable start-to-finish | StorylineEngine.test.ts | Tested |
| P1 | Full mage path is completable start-to-finish | StorylineEngine.test.ts | Tested |
