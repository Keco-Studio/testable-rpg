...
| P1 | Overwriting a slot replaces completely | SaveSystem.test.ts | Tested |
| P1 | Loading invalid/malformed JSON returns null, never throws | SaveSystem.test.ts | Tested |
| P1 | All 3 slots are independent | SaveSystem.test.ts | Tested |
